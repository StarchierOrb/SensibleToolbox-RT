...
public class SCURelay extends BatteryBox {
    ...
    public String[] getExtraLore() {
        ...
        res[lore.length] = "§a 连接于两个设备";
        res[lore.length + 1] = "§d总是有相同的SCU水平.";
        res[lore.length + 2] = "§d显示的输出可能会延迟";
        res[lore.length + 3] = "左键点击： §b刷新";
        return res;
    }
...
//    }
    ...
    private void updateInfoLabel(RelayData data) {
        ...
        getGUI().addLabel("SCU继电器 : #" + relayId, 0, null,
                ChatColor.DARK_AQUA + "已连接设备位置: " + locStr,
                "继电器只能接受电力/供电", "* 只有两个设备连接后才能运作");
    }
    ...
    public void onBlockRegistered(Location location, boolean isPlacing) {
        ...
        if (relayData.block1 == null) {
            ...
            // shouldn't happen!
            LogUtils.warning("发送严重错误！trying to register more than 2 SCU relays of ID " + relayId);
        }
