...
public class EjectorUpgrade extends MachineUpgrade implements Directional {
    ...
    public String getItemName() {
        ...
        return "机器升级组件 · " + ChatColor.GOLD + "弹射装置";
    }
    ...
    public String[] getLore() {
        return new String[]{"TID:503", "将这个升级材料放入一台STB机器中进行升级", "* 效果：自动将产生的物品弹射出来", "左键点击机器： 改变物品弹射方向"};
    }
    ...
    private InventoryGUI createGUI(Player player) {
        final InventoryGUI theGUI = GUIUtil.createGUI(player, this, 27, ChatColor.DARK_RED + "弹射设置");
        theGUI.addLabel("弹射方向", DIRECTION_LABEL_SLOT, null,
                "设置弹射方向", "机器将会沿着设置的方向弹射物品");

        ItemStack texture = GUIUtil.makeTexture(getMaterialData(), "弹射方向");
