...
public abstract class CombineHoe extends BaseSTBItem {
    ...
    public String[] getLore() {
        ...
        return new String[]{
			    "TID:500",
                "右键点击 泥土/草方块:" + ChatColor.RESET + " 耕种 3x3的区域",
                "右键点击 耕地:" + ChatColor.RESET + " 播种 3x3的区域",
                "右键点击 :" + ChatColor.RESET + " 打开种子袋",
                "左键点击 农作物:" + ChatColor.RESET + " 收获 " + s + " 的区域",
                "左键点击 树叶:" + ChatColor.RESET + " 破坏 3x3x3的树叶",
        };
    }
