...
public class PaintBrush extends BaseSTBItem implements IconMenu.OptionClickEventHandler {
    ...
    public String[] getLore() {
        return allowWoodStaining() ?
                new String[] {
                        ...
                        "木板和木台阶:",
                        " - 灰色/白色/棕色/粉红色/橙色/黑色",
                        "右键方块: 给 " + getMaxBlocksAffected() + "个方块上漆",
                        UnicodeSymbol.ARROW_UP.toUnicode() + " + 右键方块: 给方块上漆",
                        UnicodeSymbol.ARROW_UP.toUnicode() + " + 右键空气: 清空漆刷",
                } :
                new String[] {
                        "给可着色的方块上漆:",
                        " - 羊毛, 地毯, 染色粘土/玻璃",
    ...
    public void onInteractEntity(PlayerInteractEntityEvent event) {
        ...
        if (e instanceof Colorable) {
            ...
            if (getPaintLevel() >= a.getBlockHeight() * a.getBlockWidth()) {
                ...
                HoloMessage.popup(event.getPlayer(), loc, ChatColor.RED + "颜料不足了!");
            }
        } 
    ...
    private IconMenu buildMenu(Painting painting) {
        ...
        IconMenu menu = new IconMenu("选择模式", STBUtil.roundUp(other.length, 9), this, getProviderPlugin());
        int pos = 0;
        for (Art a : other) {
