    ...
    public String[] getLore() {
        switch (getMode()) {
            case BUILD:
                return new String[]{
						"TID:97",
                        "左键点击 方块: " + ChatColor.RESET + "预览",
                        "右键点击 方块: " + ChatColor.RESET + "建造",
                        UnicodeSymbol.ARROW_UP.toUnicode() + " + 右击方块: " + ChatColor.RESET + "建造一个方块",
                        UnicodeSymbol.ARROW_UP.toUnicode() + " + 鼠标中键: " + ChatColor.RESET + "切换 替换模式"
                };
            case EXCHANGE:
                return new String[]{
						"TID:96",
                        "左键点击 方块: " + ChatColor.RESET + "替换一个方块",
                        "右键点击 方块: " + ChatColor.RESET + "替换多个方块",
                        UnicodeSymbol.ARROW_UP.toUnicode() + " + 右击方块: " + ChatColor.RESET + "设置目标方块",
                        UnicodeSymbol.ARROW_UP.toUnicode() + " + 鼠标中键: " + ChatColor.RESET + "切换 建造模式"
                };
            default:
                return new String[0];
        }
